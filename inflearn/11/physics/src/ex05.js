...
export default function example() {
  ...
  // 성능관련 세팅
  cannonWorld.allowSleep = true; // 일정시간 지나면 충돌체크(테스트)를 수행하지 않음.
  cannonWorld.broadphase = new CANNON.SAPBroadphase(cannonWorld); // 여러가지 옵션이 있지만, Sap 옵션이 가장 좋음.
  // SAPBroadphase  // 제일좋음
  // NaiveBroadphase // 기본값
  ...
  function collide(e) {
    // favicon이 없다는 이벤트가 발생하기도 하지만 무시하는걸로..
