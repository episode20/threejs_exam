...
export default function example() {
  ...
  function draw() {
    ...
    // const direction = new THREE.Vector3(0, 0, -1); // 방향을 설정할땐 -1 , -100으로 설정하면 normalize로 정규화
    const direction = new THREE.Vector3(0, 0, -100); // 방향을 설정할땐 -1 , -100으로 설정하면 normalize로 정규화
    direction.normalize();
