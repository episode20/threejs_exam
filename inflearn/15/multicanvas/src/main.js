...
/**
 * 주제: 여러개의 캔버스 사용하기
		- 공식문서 (Threejs Fundamemtals)
			: 다중캔버스, 다중 장면 만들기
		- 브라우저마다 threejs canvas는 8개이상 노출할 수 없음.
			: 여러개를 생성하더라도, threejs 자원을 각각 생성하여 사용함.
			: 하나의 캔버스/렌더러를 생성하여, 영역을 지정(잘라서)하고 threejs scene을 세개를 생성하여, 해당 영역에 노출함.
